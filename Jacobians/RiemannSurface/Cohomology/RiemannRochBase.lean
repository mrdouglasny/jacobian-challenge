...
Axiom-free base definitions and facts about the concrete Riemann-Roch spaces `L(D)`.
This module is kept below the axiom-level RR/Serre wrappers so Layer 3 can use
`h0`, `h0_zero`, and finite-dimensionality without importing those wrappers.
-/
