...
No `axiom`, no gaps.
-/
import Submission.KirovDolbeault.Discharge.Manifold.ChartedSpaceLocPathConnected
import Submission.KirovDolbeault.Discharge.Manifold.ConnectedManifoldPathConnected
import Submission.KirovDolbeault.Discharge.Manifold.ChartLocalDetour
import Submission.KirovDolbeault.Discharge.Manifold.IsPathConnectedBallMinusCountable
import Submission.KirovDolbeault.Discharge.Manifold.ChartRestrictionToBall
import Submission.KirovDolbeault.Discharge.Manifold.PathSubdivisionByBallCharts
import Submission.KirovDolbeault.Discharge.Manifold.ChartOverlapAvoidanceFull
