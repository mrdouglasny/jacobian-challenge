...
Authors: Rado Kirov
-/
import Submission.KirovDolbeault.Dolbeault.MeromorphicCousin
import Submission.KirovDolbeault.Dolbeault.GlobalResidueConstruct
...
(`lDim K = kirovGenus X`, proven via `CanonicalFormIso`), and Forster §14 finiteness (`finH1`, PROVEN
