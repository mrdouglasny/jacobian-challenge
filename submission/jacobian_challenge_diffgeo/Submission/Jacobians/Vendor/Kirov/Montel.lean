...
import Submission.Jacobians.Vendor.Kirov.Genus
import Submission.Jacobians.Vendor.Kirov.Montel.Cover
import Submission.Jacobians.Vendor.Kirov.Montel.LocalRep
import Submission.Jacobians.Vendor.Kirov.Montel.ChartNorm
import Submission.Jacobians.Vendor.Kirov.Montel.SupNorm
import Submission.Jacobians.Vendor.Kirov.Montel.Compactness
import Submission.Jacobians.Vendor.Kirov.Montel.ChartTransition
import Submission.Jacobians.Vendor.Kirov.Montel.Complete
...
noncomputable def HolomorphicOneForms.supNormKAsAddGroupNorm :
    AddGroupNorm (Jacobians.Vendor.Kirov.HolomorphicOneForms X) where
...
higher level (as done in `Jacobians.Vendor.Kirov.HolomorphicForms`). -/
@[reducible] noncomputable def HolomorphicOneForms.normedAddCommGroup :
    NormedAddCommGroup (Jacobians.Vendor.Kirov.HolomorphicOneForms X) :=
...
@[reducible] noncomputable def HolomorphicOneForms.normedSpace :
    ...
    NormedSpace ℂ (Jacobians.Vendor.Kirov.HolomorphicOneForms X) :=
  letI : NormedAddCommGroup (Jacobians.Vendor.Kirov.HolomorphicOneForms X) :=
...
theorem norm_mkOfCompact_localRepOnInnerShrunk_le
    (α : Jacobians.Vendor.Kirov.HolomorphicOneForms X) (x₀ : X) :
...
noncomputable def HolomorphicOneForms.embedInnerBcf (x₀ : X) :
    ...
    Jacobians.Vendor.Kirov.HolomorphicOneForms X →L[ℂ]
...
theorem HolomorphicOneForms.cauchySeq_embedInnerBcf_of_cauchySeq
    (x₀ : X)
    (αs : ℕ → Jacobians.Vendor.Kirov.HolomorphicOneForms X)
...
theorem HolomorphicOneForms.exists_convergent_subseq_of_bounded
    ...
    letI := HolomorphicOneForms.normedAddCommGroup (X := X)
    ∃ (φ : ℕ → ℕ) (_hφ : StrictMono φ) (αLim : Jacobians.Vendor.Kirov.HolomorphicOneForms X),
  ...
  let αLim : Jacobians.Vendor.Kirov.HolomorphicOneForms X := ⟨L, h_smooth⟩
...
theorem HolomorphicOneForms.closedBall_isCompact :
    ...
    IsCompact (Metric.closedBall
      (0 : Jacobians.Vendor.Kirov.HolomorphicOneForms X) 1) := by
  letI := HolomorphicOneForms.normedAddCommGroup (X := X)
  letI := HolomorphicOneForms.normedSpace (X := X)
...
instances are in scope (typically provided in Jacobians.Vendor.Kirov.HolomorphicForms),
