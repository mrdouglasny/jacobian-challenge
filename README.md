...
| **2. RR/Serre/sheaf subchallenge** — `RiemannSurface/Cohomology/` | discharge the deep axioms via the Layer-3 tower | **no** — the challenge *rests on* the axioms; this *proves* them | RR/Serre now **theorems** (Layer-3 tower); + an **optional** adelic `H¹` construction kept around (3 `sorry`s) |
