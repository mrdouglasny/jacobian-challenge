...
**Active project axioms: 43** — all **43** in our own modules. The vendored
...
| 2c — atlas / structure | 14 | curve-specific chart constructions | real but unverified |
...
#   prints 43 — the vendored Kirov subtree is now axiom-free, so 43 is the total.
