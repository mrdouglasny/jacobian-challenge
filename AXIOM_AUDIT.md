...
onto the exhibited cover; `riemannRochL3`, `serreDualityL3`, `AX_RiemannRoch`,
`AX_SerreDuality` are now **standard-3** — the Layer-3 Riemann-Roch closure is
