...
**Active project axioms: 32** — all **32** in our own modules (the #52
...
`#print axioms` standard-3, net −1, 33 → 32; Phase D
...
- **Class 3 — Layer-3 primitives** (4 axioms after the Phase-D
  discharges). Standard cohomology and
...
#   prints 32 — the vendored Kirov subtree is now axiom-free, so 32 is the total (incl. 2+2 Layer-3 axioms after the Phase-D H1coh(+3 instances)+cohomologyLES discharges; less the 5 discharged RR/Serre+H1, the 3 discharged period-cluster axioms, PlaneCurve.instChartedSpace #117 + instIsManifold #52, and the 3 trace-cluster axioms #26/#27/#28).
...
LEAN
lake env lean /tmp/axcount.lean   # → project axioms (non-vendor): 32
